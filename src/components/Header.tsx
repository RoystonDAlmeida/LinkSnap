  ...
  return (
    <header className="border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 sticky top-0 z-50">
      <div className="container mx-auto px-2 py-3 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
        ...
        {/* Left: Logo, mobile icons, mobile buttons */}
        <div className="flex flex-col w-full sm:w-auto sm:flex-row sm:items-center sm:justify-start">
          <div className="flex flex-col items-center w-full sm:flex-row sm:items-center sm:justify-start">
            ...
            {/* Mobile: Centered below logo/title */}
            {!user && (
              <div className="flex flex-row gap-3 mt-6 w-full justify-center sm:hidden">
                <Link to="/signin">
        ...
        {/* Center: Centered clickable title for authenticated users (desktop only) */}
        <div className="flex-1 justify-center min-w-0 hidden sm:flex">
          {centerTitle}
        </div>

        {/* Right: Desktop sign in/get started buttons */}
        {!user && (
        ...
        {/* Right: Authenticated user menu (desktop) */}
        {user && (
